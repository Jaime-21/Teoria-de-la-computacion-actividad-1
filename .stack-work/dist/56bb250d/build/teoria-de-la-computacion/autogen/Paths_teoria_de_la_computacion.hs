...
{-# OPTIONS_GHC -w #-}
module Paths_teoria_de_la_computacion (
    version,
...
getDynLibDir  = catchIO (getEnv "teoria_de_la_computacion_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "teoria_de_la_computacion_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "teoria_de_la_computacion_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "teoria_de_la_computacion_sysconfdir") (\_ -> return sysconfdir)
